         ...
         <div class="panel lobidisable panel-bd">
            ...
            <div class="row">
               <div class="col-md-6 col-xl-6 col-sm-12">
                  ...
                  <form action="{{ route('add.other.sale') }}" method="post">
                     @csrf
                     ...
                     <div class="reset-button">
                        <button type="submit" class="btn btn-add pull-right w-md m-b-5">Save</button>
                     </div>
                  </form>
                  </div>
               </div>
                  <div class="col-md-6 col-xl-6 col-sm-12"> 
                     ...
                     <form method="post">
                        ...
                        <a href="{{ route('other.sale.view') }}" class="btn btn-add w-md m-b-5">View & Print</a>
                        ...
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                           ...
                           <tbody id="productTable">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <a href="{{ route('delete.other.sale', $sale->id) }}" type="button" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash-o"></i> </a>
                                 </td>
                              </tr>
                              @endforeach
