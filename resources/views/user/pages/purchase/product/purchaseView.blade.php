    ...
    <div id="wrapper">
      ...
      <article>
       ...
       @endforeach
        ...
        <address contentreadonly>
          <p>
            Name: {{ $allPurchase['0']['customer_name'] }}<br>
      ...
      <aside>
        ...
        <a href="{{ route('purchase.print') }}" target="_blank" style="padding:10px;background:rgb(10 65 67 / 89%);color:#fff;float:right;"><img src="{{ asset('public/component') }}/assets/dist/img/printer.png" style="width:30px;height:24px;padding:0;margin-right:4px;margin-top:-3px;">Print</a>

        <a href="{{ route('product.purchase') }}" style="padding:10px;background:rgb(10 65 67 / 89%);color:#fff;float:right;margin-right:5px;"><img src="{{ asset('public/component') }}/assets/dist/img/home-icon.png" style="width:30px;height:24px;padding:0;margin-right:4px;margin-top:-3px;">Home</a>
      </aside>
      @else
