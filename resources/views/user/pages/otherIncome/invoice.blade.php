  ...
  <head>
    ...
    <style type="text/css">
      ...
      *[contentreadonly]:hover, *[contentreadonly]:focus, td:hover *[contentreadonly], td:focus *[contentreadonly], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
      ...
      html { background: #fff; cursor: default; color:#000; }
      body { box-sizing: border-box; margin:50px auto;}
      #wrapper{height: auto; margin: 20px auto; width: 92%; }
      body { background: #FFF;}
      ...
      header img { max-height: 100%; max-width: 50%; float:left;}
